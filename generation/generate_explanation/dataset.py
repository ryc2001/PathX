...
class Dataset:
    ...
    def __init__(self,
        ...
        # note: the "load" flag is necessary because the pathX datasets do not require loading,
        ...
        if subgraph:
            self.train_path = os.path.join(self.home, "subgraph.txt")
        else:
        ...
        if load:
            ...
            # import json
            # with open('/data/zhaotianzhe/ryc/AttributionAttack-main/KGEAttack/ConvE/data/target_transe_WN18RR_0/entities_dict.json','w') as f:
            #     json.dump(self.entity_name_2_id,f)
            # with open('/data/zhaotianzhe/ryc/AttributionAttack-main/KGEAttack/ConvE/data/target_transe_WN18RR_0/relations_dict.json','w') as f:
            #     json.dump(self.relation_name_2_id,f)
    ...
    @staticmethod
    def replace_entity_in_sample(sample, old_entity1: int, new_entity1:int, as_numpy=True):
        h, r, t = sample
        if h == old_entity1:
            h = new_entity1
        if t == old_entity1:
    ...
    @staticmethod
    def replace_entity_rel_in_samples(samples, old_entity1: int, new_entity1:int, as_numpy=True):
        result = []
