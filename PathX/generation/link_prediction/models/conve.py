...
from link_prediction.models.model import Model, DIMENSION, INPUT_DROPOUT, FEATURE_MAP_DROPOUT, HIDDEN_DROPOUT, HIDDEN_LAYER_SIZE, pathXModel
...
class ConvE(Model):
    ...
    def __init__(self,
        ...
        # note: the init_random parameter is important because when initializing a pathXModel,
        ...
        # We do not use the torch.Embeddings module here in order to keep the code uniform to the LPFT-training model,
...
class pathXConvE(pathXModel, ConvE):
    def __init__(
            self,
        ...
        #       self.pathX_entity_embedding = Parameter(torch.rand(1, 2*self.dimension), requires_grad=True).cuda()
